...
class AddTotalScreen extends StatefulWidget {
  ...
  const AddTotalScreen(Object? arguments, {super.key, this.totalBalanceModel});
...
class _AddTotalScreenState extends State<AddTotalScreen> {
  ...
  void initState() {
    super.initState();
    if (widget.totalBalanceModel != null) {
      totalBalanceController.text = widget.totalBalanceModel!.totalbalance;
      descriptionController.text = widget.totalBalanceModel!.totaldes;
    }
                            ...
                            if (widget.totalBalanceModel == null) {
                              ...
                              SharedPref.setTotalBalance(
                                  totalBalance: double.parse(
                                      Tools.removeCommaSeparator(
                                          totalBalanceController.text)));
                              FirebaseService().saveTotalBalanceToFirestore(
                                  totalBalanceModel);
                              Navigator.of(context).pop();
                            } else {
                              TotalBalanceModel totalBalanceModel =
                                  TotalBalanceModel(
                                      totalbalanceid: widget
                                          .totalBalanceModel!.totalbalanceid,
                                      totalbalance: Tools.removeCommaSeparator(
                                          totalBalanceController.text),
                                      totaldes: descriptionController.text,
                                      insertdate:
                                          widget.totalBalanceModel!.insertdate,
                                      starttimerangedate: widget
                                          .totalBalanceModel!
                                          .starttimerangedate,
                                      endtimerangedate: widget
